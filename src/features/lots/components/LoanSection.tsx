  ...
  return (
    <div className=" w-full h-fit flex flex-col gap-[44px]">
      ...
      <div className=" w-full h-fit flex flex-col gap-8">
        ...
        <div className=" w-full h-fit flex justify-between gap-x-[75px]">
          <div className=" w-[259px] h-fit">
            <button className=" w-fit h-fit text-gray-800 leading-[18px] text-[18px] font-medium">
              сбор денег
            </button>
          </div>
          <div className=" w-full flex flex-col gap-2">
            <div className=" w-full h-fit flex items-center justify-between">
              <p className=" text-primary-blue font-medium text-[18px] leading-[24px]">
                1 399 499 ₽
              </p>
              <p className=" text-gray-light font-medium text-[18px] leading-[24px]">
                из 5 700 000 ₽
              </p>
            </div>
      ...
      <div className=" w-full h-fit flex flex-col gap-8">
        <p className=" font-bold text-[20px] leading-[28px] text-blue-500">
          Документы
        </p>

        <div className=" w-full max-w-[660px] h-[69.47px] px-4 py-5 rounded-[4px] border flex items-center justify-between bg-gray-500">
          <p className=" font-medium leading-[18px] text-[18px] text-blue-500">
